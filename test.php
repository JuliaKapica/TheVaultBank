...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$recaptchaResultJson['success']) {
        ...
        if ($emailCount > 0) {
            // Kontynuacja tylko jeśli email istnieje w bazie danych
            ...
            $message .= "https://juliuszdrojecki.pl/projekt_php_studia/Bank%20F_J/potwierdz.php?link=" . urlencode($verificationLink);
            $message .= "\nNumer Twojego konta do zalogowania to: " . $numerKonta . "\n\n";
